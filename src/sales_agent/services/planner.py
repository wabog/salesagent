    ...
    def _compose_llm_prompt(
        ...
        *,
        ...
        parts = [
            ...
            "The Contact block is the current source of truth for CRM state, followups, and calendar availability.",
            "Recent messages and semantic memories are historical conversation text. Use them for continuity, but do not treat old mentions of scheduled demos, meeting links, reminders, or followups as current state.",
            "Only say there is a future demo or offer to remind a demo link when Contact.metadata.calendar.upcoming_event is present and its start/end is after the current datetime.",
            "If Contact.metadata.calendar.upcoming_event is null, the lead has no known future demo even if historical messages mention one.",
            "Treat calendar events or followups before this instant as past, not upcoming.",
            "",
            "Contact:",
            contact_json,
            "",
        ...
        rendered = {
            ...
            "metadata": {
                ...
                "calendar": {
                    ...
                    "has_future_meeting": upcoming_event is not None,
